package br.com.warehouse.warehouse.exceptionhandler;
...
public class WarehouseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<Object> handleResponsavelNotFoundException(ResponsavelNotFoundException ex, HttpServletRequest request){
        String mensagemUsuario = messageSource.getMessage("responsavel.not-found", null, LocaleContextHolder.getLocale());
